...
**
** Created: Thu Aug 11 17:22:00 2011
...
static const char qt_meta_stringdata_Cliente[] = {
    "Cliente\0\0mensaje\0enviarPeticion(QString)\0"
    "mostrarRespuesta()\0"
};

const QMetaObject Cliente::staticMetaObject = {
    { &QTcpSocket::staticMetaObject, qt_meta_stringdata_Cliente,
...
int Cliente::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: enviarPeticion((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: mostrarRespuesta(); break;
        default: ;
        }
        _id -= 2;
    }
